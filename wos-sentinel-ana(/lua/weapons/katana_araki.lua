...
SWEP.ViewModel = "models/weapon/personal_araki.mdl"
SWEP.WorldModel = "models/weapon/personal_araki.mdl"
...
SWEP.PrintName = "Katana Araki" --Name of the lightsaber
SWEP.Class = "katana_araki" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/personal_araki.mdl" -- Model path of the hilt
