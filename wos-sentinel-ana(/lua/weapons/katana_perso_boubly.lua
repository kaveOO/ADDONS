...
SWEP.ViewModel = "models/izuki/claymore8.mdl"
SWEP.WorldModel = "models/izuki/claymore8.mdl"
...
SWEP.PrintName = "Katana Démon Boubly" --Name of the lightsaber
SWEP.Class = "katana_perso_boubly" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/claymore8.mdl" -- Model path of the hilt
