...
SWEP.Category = "Katana - Personnalisées"
...
SWEP.ViewModel = "models/models/souls_worldmodel_falko/weapons/typ_yoru_sold.mdl"
SWEP.WorldModel = "models/models/souls_worldmodel_falko/weapons/typ_yoru_sold.mdl"
...
SWEP.PrintName = "Katana Pourfendeur Urakan" --Name of the lightsaber
SWEP.Class = "katana_urakan" --The file name of this swep
...
SWEP.UseHilt = "models/models/souls_worldmodel_falko/weapons/typ_yoru_sold.mdl" -- Model path of the hilt
