...
SWEP.ViewModel = "models/izuki/claymore24.mdl"
SWEP.WorldModel = "models/izuki/claymore24.mdl"
...
SWEP.PrintName = "Katana Démon Yakeroo" --Name of the lightsaber
SWEP.Class = "katana_perso_yakeroo" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/claymore24.mdl" -- Model path of the hilt
