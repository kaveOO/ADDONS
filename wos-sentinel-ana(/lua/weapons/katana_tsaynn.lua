...
SWEP.ViewModel = "models/weapon/w_demon_katana.mdl"
SWEP.WorldModel = "models/weapon/w_demon_katana.mdl"
...
SWEP.PrintName = "katana Tsaynn" --Name of the lightsaber
SWEP.Class = "katana_tsaynn" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/w_demon_katana.mdl" -- Model path of the hilt
