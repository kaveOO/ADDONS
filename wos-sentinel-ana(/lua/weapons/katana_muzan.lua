...
SWEP.ViewModel = "models/izuki/claymore54.mdl"
SWEP.WorldModel = "models/izuki/claymore54.mdl"
...
SWEP.PrintName = "Katana Muzan Only" --Name of the lightsaber
SWEP.Class = "katana_muzan.lua" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/claymore54.mdl" -- Model path of the hilt
SWEP.UseLength = 70 -- Length of the saber 
SWEP.UseWidth = 15 -- Width of the saber
