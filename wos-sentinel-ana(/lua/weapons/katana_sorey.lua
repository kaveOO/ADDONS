...
SWEP.ViewModel = "models/izuki/katana12.mdl"
SWEP.WorldModel = "models/izuki/katana12.mdl"
...
SWEP.PrintName = "Katana Sorey" --Name of the lightsaber
SWEP.Class = "katana_sorey" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/katana12.mdl" -- Model path of the hilt
