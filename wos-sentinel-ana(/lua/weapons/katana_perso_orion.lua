...
SWEP.WorldModel = "models/weapons/c_katana.mdl"
...
SWEP.PrintName = "Katana Démon Orion" --Name of the lightsaber
SWEP.Class = "katana_perso_orion" --The file name of this swep
...
SWEP.UseHilt = "models/weapons/c_katana.mdl" -- Model path of the hilt
