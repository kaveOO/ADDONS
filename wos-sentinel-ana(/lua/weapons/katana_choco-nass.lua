...
SWEP.ViewModel = "models/morax.mdl"
SWEP.WorldModel = "models/morax.mdl"
...
SWEP.PrintName = "Katana Choco" --Name of the lightsaber
SWEP.Class = "katana_choco&nass" --The file name of this swep
...
SWEP.UseHilt = "models/morax.mdl" -- Model path of the hilt
