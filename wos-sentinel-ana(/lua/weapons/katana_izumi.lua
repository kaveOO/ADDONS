...
SWEP.ViewModel = "models/weapon/personal_redobanai.mdl"
SWEP.WorldModel = "models/weapon/personal_redobanai.mdl"
...
SWEP.PrintName = "Katana Izumi V2" --Name of the lightsaber
SWEP.Class = "katana_izumi" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/personal_redobanai.mdl" -- Model path of the hilt
