...
SWEP.ViewModel = "models/weapon/w_rose_katana.mdl"
SWEP.WorldModel = "models/weapon/w_rose_katana.mdl"
...
SWEP.PrintName = "Katana Rocks 1" --Name of the lightsaber
SWEP.Class = "katana_rouge" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/w_rose_katana.mdl" -- Model path of the hilt
