...
SWEP.ViewModel = "models/nero/katana_nero.mdl"
SWEP.WorldModel = "models/nero/katana_nero.mdl"
...
SWEP.PrintName = "Katana Naki" --Name of the lightsaber
SWEP.Class = "katana_naki" --The file name of this swep
...
SWEP.UseHilt = "models/nero/katana_nero.mdl" -- Model path of the hilt
