...
SWEP.ViewModel = "models/izuki/lance6.mdl"
SWEP.WorldModel = "models/izuki/lance6.mdl"
...
SWEP.PrintName = "Katana Démon LS6" --Name of the lightsaber
SWEP.Class = "katana_perso_ls6" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/lance6.mdl" -- Model path of the hilt
