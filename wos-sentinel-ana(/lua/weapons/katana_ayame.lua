...
SWEP.ViewModel = "models/weapon/personal_katayame.mdl"
SWEP.WorldModel = "models/weapon/personal_katayame.mdl"
...
SWEP.PrintName = "Katana Ayame" --Name of the lightsaber
SWEP.Class = "katana_ayame" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/personal_katayame.mdl" -- Model path of the hilt
