...
SWEP.ViewModel = "models/izuki/katana6.mdl"
SWEP.WorldModel = "models/izuki/katana6.mdl"
...
SWEP.PrintName = "Katana Pourfendeur Jin" --Name of the lightsaber
SWEP.Class = "katana_perso_jinelio" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/katana6.mdl" -- Model path of the hilt
