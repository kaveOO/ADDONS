...
SWEP.PrintName = "Demo Lightsaber 3" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_wos_demo3" --The file name of this swep
...
SWEP.UseLength = { 50, 100 } -- Length of the saber 
