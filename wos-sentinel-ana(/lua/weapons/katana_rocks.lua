...
SWEP.ViewModel = "models/weapon/personal_rocks_2.mdl"
SWEP.WorldModel = "models/weapon/personal_rocks_2.mdl"
...
SWEP.PrintName = "Katana Rocks 2" --Name of the lightsaber
SWEP.Class = "katana_rocks" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/personal_rocks_2.mdl" -- Model path of the hilt
