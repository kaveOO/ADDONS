...
SWEP.WorldModel = "models/izuki/katana5.mdl"
...
SWEP.PrintName = "Katana Pourfendeur #2" --Name of the lightsaber
SWEP.Class = "katana_pourfendeur" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/katana5.mdl" -- Model path of the hilt
