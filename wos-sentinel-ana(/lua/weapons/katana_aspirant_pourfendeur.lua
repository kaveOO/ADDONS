...
SWEP.Category = "Katana - Ordre Pourfendeurs"
...
SWEP.WorldModel = "models/izuki/katana16.mdl"
...
SWEP.PrintName = "Katana Pourfendeur #1" --Name of the lightsaber
SWEP.Class = "katana_aspirant_pourfendeur" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/katana16.mdl" -- Model path of the hilt
