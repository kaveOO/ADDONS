...
SWEP.PrintName = "Offhand Lightsaber ( Demo 1 )" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_wos_offhand_demo1" --The file name of this swep
...
SWEP.OffhandOnly = true -- Only use the offhand lightsaber
SWEP.ShouldAerialRecover = true -- Do not do the recovery landing freeze when landing

--Use these options to overwrite the player's commands
SWEP.UseHilt = false -- Model path of the hilt
SWEP.UseLength = { 20, 80 } -- Length of the saber 
SWEP.UseWidth = { 2, 4 } -- Width of the saber
SWEP.UseColor = { Color( 255, 0, 0 ), Color( 0, 0, 255 ) } -- RGB Color of saber. Red = Color( 255, 0, 0 ) Blue = Color( 0, 0, 255 ), etc.
SWEP.UseDarkInner = { true, false } -- Does it have a dark inner? 1 = true
...
SWEP.UseSecLength = { 32, 64 }
SWEP.UseSecWidth = false
SWEP.UseSecColor = { Color( 0, 255, 0 ), Color( 255, 0, 255 ) } -- RGB Color of saber. Red = Color( 255, 0, 0 ) Blue = Color( 0, 0, 255 ), etc.
