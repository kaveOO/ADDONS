...
SWEP.ViewModel = "models/weapon/personal_redobanai_red.mdl"
SWEP.WorldModel = "models/weapon/personal_redobanai_red.mdl"
...
SWEP.PrintName = "Katana Izumi V1" --Name of the lightsaber
SWEP.Class = "katana_izumi_red" --The file name of this swep
...
SWEP.UseHilt = "models/weapon/personal_redobanai_red.mdl" -- Model path of the hilt
