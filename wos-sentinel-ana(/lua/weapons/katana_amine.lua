...
SWEP.ViewModel = "models/izuki/lance32.mdl"
SWEP.WorldModel = "models/izuki/lance32.mdl"
...
SWEP.PrintName = "Katana Amine" --Name of the lightsaber
SWEP.Class = "katana_amine" --The file name of this swep
...
SWEP.UseHilt = "models/izuki/lance32.mdl" -- Model path of the hilt
SWEP.UseLength = 80 -- Length of the saber 
