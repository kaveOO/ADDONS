...
SWEP.ViewModel = "models/izuki_jiang.mdl"
SWEP.WorldModel = "models/izuki_jiang.mdl"
...
SWEP.PrintName = "Katana Démon Naga" --Name of the lightsaber
SWEP.Class = "katana_perso_naga" --The file name of this swep
...
SWEP.UseHilt = "models/izuki_jiang.mdl" -- Model path of the hilt
