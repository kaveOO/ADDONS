local TREE = {}
TREE.Name = "Pouvoir Sanguinaire Du Magma Rang C a B"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_C_MAGMA", "TEAM_DEMON_B_MAGMA"
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 45 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 45 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 115 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 115 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
