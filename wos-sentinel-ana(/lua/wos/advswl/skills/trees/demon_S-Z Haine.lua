local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De La Haine Rang S+ a Z"
TREE.Description = ""
...
TREE.JobRestricted = { 
	 "TEAM_DEMON_SS_HAINE", "TEAM_DEMON_Z_HAINE"
}
TREE.Tier = {}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 800 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 800 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 190 end,
}
