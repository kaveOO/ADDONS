local TREE = {}
TREE.Name = "Souffle de L'Insecte de Tsuchinoto a Hinoto"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_TSUCHINOTO_INSECTE" , "TEAM_TSUCHINOE_INSECTE" , "TEAM_HINOTO_INSECTE" ,
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 95 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 95 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 365 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 365 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 80 end,
}
