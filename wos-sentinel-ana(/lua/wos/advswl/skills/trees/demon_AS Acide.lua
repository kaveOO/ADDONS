local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De L'Acide Rang A a S"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_A_LARMES", "TEAM_DEMON_AA_LARMES", "TEAM_DEMON_S_LARMES"
}
TREE.Tier = {}
...
TREE.Tier[3][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 85 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 85 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
