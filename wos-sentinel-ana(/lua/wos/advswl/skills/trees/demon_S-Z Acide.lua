local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De L'Acide Rang S+ a Z"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_SS_LARMES", "TEAM_DEMON_Z_LARMES"
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 220 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 220 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 900 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 900 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
