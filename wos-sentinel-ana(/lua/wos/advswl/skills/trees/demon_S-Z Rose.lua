local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De La Rose Rang S+ a Z"
TREE.Description = ""
...
TREE.JobRestricted = { 
	 "TEAM_DEMON_SS_ROSE", "TEAM_DEMON_Z_ROSE"
}
TREE.Tier = {}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 700 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 700 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 105 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
