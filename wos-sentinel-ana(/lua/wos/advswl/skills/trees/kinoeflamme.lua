local TREE = {}
TREE.Name = "Arbre Kinoe - Souffle Flamme"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre1.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAM_KINOE_FLAMME" }
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 650 end,
}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetMaxArmor( ply:GetMaxArmor() + 60 ) ply:SetArmor( ply:Armor() + 60 ) end,
	OnPlayerDeath = function( ply ) end,
