local TREE = {}
TREE.Name = "Pouvoir Sanguinaire Du Tonnerre Rang C a B"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_C_TONNERRE", "TEAM_DEMON_B_TONNERRE"
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ...
        ply:SetMaxArmor( ply:GetMaxArmor() + 150 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 60 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 65 end,
}
...
TREE.Tier[4][1] = {
	...
	OnPlayerSpawn = function( ply )
        ...
        ply:SetMaxArmor( ply:GetMaxArmor() + 50 ) 
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[4][4] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 40 end,
}
