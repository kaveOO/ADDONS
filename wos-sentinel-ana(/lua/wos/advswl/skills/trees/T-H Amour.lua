local TREE = {}
TREE.Name = "Souffle de L'Amour de Tsuchinoto a Hinoto"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_TSUCHINOTO_AMOUR" , "TEAM_TSUCHINOE_AMOUR" , "TEAM_HINOTO_AMOUR" ,
}
TREE.Tier = {}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 465 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 465 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 85 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 90 end,
}
