local TREE = {}
TREE.Name = "Palier de la Inferieur 6"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre2.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAM_LUNE_IF_6" }
TREE.Tier = {}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetMaxArmor( ply:GetMaxArmor() + 300 ) ply:SetArmor( ply:Armor() + 300 ) end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 430 ) end, 
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
