local TREE = {}
TREE.Name = "Pouvoir Sanguinaire Du Magma Rang S+ a Z"
TREE.Description = ""
...
TREE.JobRestricted = { 
	 "TEAM_DEMON_SS_MAGMA", "TEAM_DEMON_Z_MAGMA"
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 175 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 175 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 765 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 765 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 90 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 150 end,
}
