local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De La Larmes Rang C a B"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_C_LARMES", "TEAM_DEMON_B_LARMES"
}
TREE.Tier = {}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 85 end,
}
