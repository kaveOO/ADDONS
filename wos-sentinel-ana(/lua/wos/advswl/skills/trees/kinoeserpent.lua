local TREE = {}
TREE.Name = "Arbre Kinoe - Souffle Serpent"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre1.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAM_KINOE_SERPENT" }
TREE.Tier = {}
...
TREE.Tier[1][1] = {
	...
	OnSaberDeploy = function( wep )
		wep:AddForm( "Technique - Serpentt" , 1 )
...
TREE.Tier[2][1] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 540 end,
}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetMaxArmor( ply:GetMaxArmor() + 150 ) ply:SetArmor( ply:Armor() + 150 ) end,
	OnPlayerDeath = function( ply ) end,
