local TREE = {}
TREE.Name = "Pouvoir Sanguinaire De La Rose Rang C a B"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_C_ROSE", "TEAM_DEMON_B_ROSE"
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetArmor( ply:Armor() + 35 )
        ply:SetMaxArmor( ply:GetMaxArmor() + 35 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 45 end,
}
