local TREE = {}
TREE.Name = "Palier de Muzan"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre2.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAMORIGINEL" }
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 2500 end,
}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetMaxArmor( ply:GetMaxArmor() + 35000 ) ply:SetArmor( ply:Armor() + 35000 ) end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 820 ) end, 
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
