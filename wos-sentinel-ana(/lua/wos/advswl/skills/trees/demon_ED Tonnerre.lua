local TREE = {}
TREE.Name = "Pouvoir Sanguinaire Du Tonnerre Rang E a D"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_DEMON_E_TONNERRE" , "TEAM_DEMON_D_TONNERRE" 
}
TREE.Tier = {}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 40 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
