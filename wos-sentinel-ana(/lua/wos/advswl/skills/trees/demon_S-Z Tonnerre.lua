local TREE = {}
TREE.Name = "Pouvoir Sanguinaire Du Tonnerre Rang S+ a Z"
TREE.Description = ""
...
TREE.JobRestricted = { 
	  "TEAM_DEMON_SS_TONNERRE", "TEAM_DEMON_Z_TONNERRE"
}
TREE.Tier = {}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 140 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[2][4] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 110 end,
}
...
TREE.Tier[3][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 120 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[3][4] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 115 end,
}
...
TREE.Tier[4][2] = {
	...
	OnPlayerSpawn = function( ply )
        ...
        ply:SetMaxHealth( ply:GetMaxHealth() + 1000 ) 
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
...
TREE.Tier[4][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 100 ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
