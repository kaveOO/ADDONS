local TREE = {}
TREE.Name = "Arbre Piliers - Souffle Flamme"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre1.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAM_PILIER_FLAMME" }
TREE.Tier = {}
...
TREE.Tier[1][1] = {
	...
	OnSaberDeploy = function( wep )
		wep:AddForm( "Technique - Flamme" , 1 )
...
TREE.Tier[2][1] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 850 end,
}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetMaxArmor( ply:GetMaxArmor() + 2000 ) ply:SetArmor( ply:Armor() + 2000 ) end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 470 ) end, 
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
