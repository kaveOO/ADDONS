local TREE = {}
TREE.Name = "Arbre d'apprentissage - Tsuchinoto"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_TSUCHINOTO_AMOUR" , "TEAM_TSUCHINOTO_FOUDRE" , "TEAM_TSUCHINOTO_EAU" , "TEAM_TSUCHINOTO_FLAMME" , "TEAM_TSUCHINOTO_SERPENT" , "TEAM_TSUCHINOTO_INSECTE"
}
TREE.Tier = {}
