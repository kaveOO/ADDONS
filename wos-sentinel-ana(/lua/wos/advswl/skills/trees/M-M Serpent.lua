local TREE = {}
TREE.Name = "Souffle du Serpent de Mizunoto a Mizunoe"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_MIZUNOTO_SERPENT" , "TEAM_MIZUNOE_SERPENT" ,
}
TREE.Tier = {}
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 70 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 70 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
