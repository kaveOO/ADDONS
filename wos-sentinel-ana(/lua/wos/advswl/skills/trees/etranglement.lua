...
TREE.Name = "Etranglement"

--Description of the skill tree
TREE.Description = "Ici il y aura les mouvements et les ameliorations pour votre Pouvoir Sanguinaire."

--Icon for the skill tree ( Appears in category menu and above the skills )
TREE.TreeIcon = "materials/cosmosds/classes/acide.png"
...
TREE.JobRestricted = {TEAM_MIZUNOTO_EAU}
