local TREE = {}
TREE.Name = "Souffle du Serpent de Tsuchinoto a Hinoto"
TREE.Description = ""
...
TREE.JobRestricted = { 
	"TEAM_TSUCHINOTO_SERPENT" , "TEAM_TSUCHINOE_SERPENT" , "TEAM_HINOTO_SERPENT" ,
}
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply )
        ...
        ply:SetMaxArmor( ply:GetMaxArmor() + 100 )
    end,
	OnPlayerDeath = function( ply ) end,
...
TREE.Tier[2][2] = {
	...
	OnPlayerSpawn = function( ply )
        ply:SetHealth( ply:Health() + 380 )
        ply:SetMaxHealth( ply:GetMaxHealth() + 380 )
    end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
