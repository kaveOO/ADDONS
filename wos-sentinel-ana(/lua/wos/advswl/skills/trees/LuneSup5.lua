local TREE = {}
TREE.Name = "Palier de la Supérieure 5"
TREE.Description = ""
TREE.TreeIcon = "materials/wos/skills/arbre2.png"
TREE.BackgroundColor = Color( 255, 0, 0, 25 )
TREE.MaxTiers = 2
TREE.UserGroups = false
TREE.JobRestricted = { "TEAM_LUNE_SUP_5" }
TREE.Tier = {}
...
TREE.Tier[2][1] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep.SaberDamage = wep.SaberDamage + 790 end,
}
...
TREE.Tier[2][3] = {
	...
	OnPlayerSpawn = function( ply ) ply:SetRunSpeed( ply:GetRunSpeed() + 540 ) end, 
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) end,
}
