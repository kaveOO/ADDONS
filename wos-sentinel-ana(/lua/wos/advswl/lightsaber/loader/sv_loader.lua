...
AddCSLuaFile( dir .. "/datadesc/cl_core.lua" )
AddCSLuaFile( dir .. "/datadesc/cl_net.lua" )
AddCSLuaFile( dir .. "/core/cl_create_register.lua" )
AddCSLuaFile( dir .. "/core/cl_hud.lua" )
AddCSLuaFile( dir .. "/core/cl_core.lua" )
AddCSLuaFile( dir .. "/datadesc/sh_hooks.lua" )
...
wOS.ALCS:ServerInclude( dir .. "/datadesc/sv_core.lua" )
wOS.ALCS:ServerInclude( dir .. "/datadesc/sv_net.lua" )
