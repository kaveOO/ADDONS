...
local my_language = {
    ...
    payday_message = "Vous venez de recevoir %s!",
    ...
    found_cash = "Tu as ramassé %s%d!", -- backwards compatibility
    found_money = "Tu as ramassé %s!",
    ...
    door_sold = "Tu l'as vendu pour %s",
    door_already_owned = "Cette porte appartien deja a quelqu'un!",
    door_cannot_afford = "Vous n'avez pas assez d'argent!",
