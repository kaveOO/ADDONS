...
cfg:SetTitle("Sun&Moon | Demon Slayer RP")
...
cfg:SetShowNeedToChangeFrom(true)
...
cfg:AddURL({
	...
	url = "https://discord.gg/dHaPczNFE2",
	icon = "vHESvbx"
})
cfg:AddWebsite({
	name = "Lien - Collection",
	desc = "Collection",
	url = "https://steamcommunity.com/sharedfiles/filedetails/?id=3045392792",
	icon = "jvjxAQK"
})
--[[ Standalone commands
cfg:AddTab({
