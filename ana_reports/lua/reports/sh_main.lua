function SH_REPORTS:GetMidnight(offset)
	return os.time() - tonumber(os.date("%H")) * 3600 - tonumber(os.date("%M")) * 60 - tonumber(os.date("%S")) + 86400 * (offset or /* 76561199097817419 */ 0)
end
...
easynet.Start("SH_REPORTS.RequestPerfReportStaff" /* 76561199097817426 */)
	easynet.Add("id", EASYNET_UINT32)
easynet.Register()
